...
export default function SocialFooter({ feedbackCount, hideCTA }: SocialFooterProps) {
  return (
    <div style={{
      ...
      {/* Row 3: Supporter count — single line of text only */}
      <div style={{ fontFamily: '"Sarabun", system-ui', fontSize: 13, color: C.brownSoft, textAlign: 'center' }}>
        {feedbackCount != null ? (
          <>
            ❤️{' '}
